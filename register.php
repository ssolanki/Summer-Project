...
$usr_name = $_SESSION['userid'];
$usr_password = $_SESSION['pwd'];
...
//		$dbschema="bookmarklet";		//	older
	...
	if(!$usr_id)
	{	
		$query = "INSERT INTO auth_members(name,username,password) Values ('$name' ,'$usr_name','$usr_password') " ;
		$result = mysql_query($query) or die(mysql_error());
...
<html>
	...
	<div class='login'>
		<form action='register.php' method='POST' id="form_fill"  class="form-horizontal">
			<div class="form-group">	
			<label class="col-sm-4">Authority Name: </label> 
			<div class="col-sm-6">	
		<input type='text' name='name' class="span3" placeholder="Your Name" id='name'> 			
		</div>
			</div>
			<div class="form-group">	
	...
	<div class="form-group">
      <div class="col-sm-offset-4 col-sm-10">
			<button class="btn btn-primary" type="submit" name="submit" >Sign In</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="login.php" >Login Here </a>
		</div>
	</div>		
		</form>
	</div>
